...
def test_deal_hand():
    ...
    for k in hand.keys():
        if (not type(k) is str) or (not type(hand[k]) is int):
            print("FAILURE: test_deal_hand()")
            print("\tUnexpected type of dictionary: string -> int expected, but was" +  str(type(k)) +  "->" + str(type(hand[k])))
...
def test_is_valid_word(word_list):
    ...
    if not is_valid_word(word, hand, word_list):
        ...
        print("\tExpected True, but got False for word: '" + word + "' and hand:" + str(hand))
    ...
    if  is_valid_word(word, hand, word_list):
        print("FAILURE: test_is_valid_word()")
        print("\tExpected False, but got True for word: '" + word + "' and hand:" + str(hand))
